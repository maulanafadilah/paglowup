            ...
            <div class="p-3 px-4 border-bottom">
                <div class="d-flex align-items-start ">
                    <div class="flex-shrink-0 me-3 align-self-center">
                        <img src="<?=base_url()?>/webdata/uploads/images/designer/<?=$l_detail->designer_pic?>" class="avatar-sm rounded-circle" alt="">
                    </div>
                        ...
                        <div class="col-xl-4 col-7">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0 avatar-sm me-3 d-sm-block d-none">
                                    <img src="<?=base_url()?>/webdata/uploads/images/cs/<?=$l_detail->cs_pic?>" alt="" class="img-fluid d-block rounded-circle">
                                </div>
                                <div class="flex-grow-1">
                                    <h5 class="font-size-14 mb-1 text-truncate"><a href="#" class="text-dark"><?=$l_detail->cs_name?></a></h5>
                                    <p class="text-muted mb-0">Komentar CS</p>
                                </div>
                            </div>
                        </div>
                    </div>
