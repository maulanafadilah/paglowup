                        ...
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">List CS</li>
                                </ol>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div style="margin-bottom: 15px">
                                    <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addUserCs">
                                        Tambah CS
                                    </button>
                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-grid gap-2">
                                                    ...
                                                    <a href="<?=base_url()?>/pengelola/cs/detail/<?=$a->iduser?>" class="btn btn-sm btn-outline-info">detail</a> 
                                                    <?php }else{ ?>
...
<div id="addUserCs" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel">Tambah CS</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="konfirAdd" action="<?=base_url()?>/pengelola/cs/add_proc" method="post">
