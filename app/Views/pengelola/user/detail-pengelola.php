                        ...
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Detail Pengelola</li>
                                </ol>
                            </div>
                                    ...
                                    <div class="col-sm order-2 order-sm-1">
                                        <div class="d-flex align-items-start mt-3 mt-sm-0">
                                            ...
                                            <div class="flex-grow-1">
                                                <div>
                                                    <h5 class="font-size-16 mb-1"><?=$detail_pengelola->name?></h5>
                                                    <p class="text-muted font-size-13">Pengelola</p>

                                                    <div class="d-flex flex-wrap align-items-start gap-2 gap-lg-3 text-muted font-size-13">
                                                        <div><i class="mdi mdi-circle-medium me-1 text-success align-middle"></i><?=$detail_pengelola->phone?></div>
                                                        <div><i class="mdi mdi-circle-medium me-1 text-success align-middle"></i><?=$detail_pengelola->email?></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="mt-4 mt-lg-0">
                                            ...
                                            <form action="<?=base_url()?>/pengelola/pengelola/update_proc/<?=$detail_pengelola->iduser?>" method="post">
                                                <div class="row mb-4">
                                                    <label class="col-sm-3 col-form-label">Nama Lengkap <span class="text-danger">*</span></label>
                                                    <div class="col-sm-9">
                                                        <input type="text" name="nama" value="<?=$detail_pengelola->name?>" class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <label class="col-sm-3 col-form-label">Email <span class="text-danger">*</span></label>
                                                    <div class="col-sm-9">
                                                        <input type="email" name="email" value="<?=$detail_pengelola->email?>" class="form-control" required>
                                                        <input type="email" name="old_email" value="<?=$detail_pengelola->email?>" class="form-control" hidden>
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <label class="col-sm-3 col-form-label">Alamat <span class="text-danger">*</span></label>
                                                    <div class="col-sm-9">
                                                        <input type="text" name="alamat" value="<?=$detail_pengelola->address?>" class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <label class="col-sm-3 col-form-label">Nomor Telpon <span class="text-danger">*</span></label>
                                                    <div class="col-sm-9">
                                                        <input type="number" name="notelp" value="<?=$detail_pengelola->phone?>" class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <label class="col-sm-3 col-form-label">Nomor WhatsApp <span class="text-danger">*</span></label>
                                                    <div class="col-sm-9">
                                                        <input type="number" name="whatsapp" value="<?=$detail_pengelola->whatsapp?>" class="form-control" required>
                                                    </div>
                                                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="<?=base_url()?>/pengelola/pengelola/flag_switch/<?=$detail_pengelola->iduser?>" class="btn btn-primary">
                    Aktifkan
                </a>
            </div>
        </div><!-- /.modal-content -->
