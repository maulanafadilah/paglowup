                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addUserDesigner">
                                    Tambah Designer
                                </button>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-grid gap-2">
                                                    ...
                                                    <a href="<?=base_url()?>/pengelola/designer/detail/<?=$a->iduser?>" class="btn btn-sm btn-outline-info">detail</a> 
                                                    <?php }else{ ?>
