                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="email-leftbar card">
                            ...
                            <div class="mail-list">
                                <a href="#hero" data-bs-toggle="tab" aria-expanded="true" class="nav-link active"><i class="mdi mdi-email-outline me-2"></i> Hero <span class="ms-1 float-end">(18)</span></a>
                                <a href="#description" data-bs-toggle="tab" aria-expanded="false" class="nav-link"><i class="mdi mdi-star-outline me-2"></i>Description</a>
                                <a href="#" data-bs-toggle="tab" aria-expanded="false" class="nav-link"><i class="mdi mdi-diamond-stone me-2"></i>Recent Work</a>
                                <a href="#" data-bs-toggle="tab" aria-expanded="false" class="nav-link"><i class="mdi mdi-file-outline me-2"></i>Service</a>
                                <a href="#" data-bs-toggle="tab" aria-expanded="false" class="nav-link"><i class="mdi mdi-email-check-outline me-2"></i>Testimonials</a>
                                <a href="#" data-bs-toggle="tab" aria-expanded="false" class="nav-link"><i class="mdi mdi-trash-can-outline me-2"></i>Pricing</a>
                            </div>
                        </div>
                        <!-- End Left sidebar -->
